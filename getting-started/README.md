...
* 你有分析/商业智能的需求，并希望快速调查，分析，可视化，并要求对大量数据进行即席查询（想记录百万或数十亿）。在这种情况下，你可以使用Elasticsearch来存储你的数据，然后使用Kibana（该Elasticsearch / Logstash / Kibana堆栈的一部分），以建立一个能够可视化对您很重要的数据方面的定制仪表盘。此外，还可以使用Elasticsearch聚合功能对你的数据进行复杂的商业智能查询。
